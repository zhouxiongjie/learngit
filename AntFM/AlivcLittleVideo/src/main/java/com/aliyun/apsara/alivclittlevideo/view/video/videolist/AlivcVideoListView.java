...
//                    mAllTime = mListPlayer.getDuration();
//                    long progress = 0;
//                    if(mAllTime == 0) {
//                        progress = 0;
//                    }else{
...
//                    BaseVideoListAdapter.BaseHolder holder = (BaseVideoListAdapter.BaseHolder) recycler.findViewHolderForLayoutPosition(mCurrentPosition);
//                    if (holder != null) {
//                        holder.getPlayProgressBar().setSecondaryProgress((int)progress);
//                    }
    ...
    private void init() {
        ...
        pagerLayoutManager.setOrientation(OrientationHelper.HORIZONTAL);
    ...
    public  LittleVideoListAdapter.MyHolder getPlayPager(){
        LittleVideoListAdapter.MyHolder holder = (LittleVideoListAdapter.MyHolder) recycler.findViewHolderForLayoutPosition(mCurrentPosition);
        return holder;
    }
    ...
    public void setPlayerCount(int playerCount) {
        ...
        //mListPlayer.setMaxPreloadMemorySizeMB(300);
    }

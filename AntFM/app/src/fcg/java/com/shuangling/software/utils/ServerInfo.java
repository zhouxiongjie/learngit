...
public class ServerInfo {
    ...
    public static String live = "http://api-live.fcgtvb.com";

    public static String echo_server = "http://echo-live.fcgtvb.com";

    public static String mlive = "http://live-m.fcgtvb.com";

    public static String mlives = "https://live-m.fcgtvb.com";

    public static String shop = "http://api-shop.fcgtvb.com";

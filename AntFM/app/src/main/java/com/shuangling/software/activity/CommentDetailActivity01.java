                        ...
                        mCommentListAdapter.setOnItemReply(new LevelTwoCommentAdapter.OnItemReply() {
                            ...
                            public void replyItem(final Comment comment) {
                                if (User.getInstance() == null) {
                                    Intent it = new Intent(CommentDetailActivity01.this, NewLoginActivity.class);
                                    startActivity(it);
                                }else if (User.getInstance() !=null&&TextUtils.isEmpty(User.getInstance().getPhone())) {

                                    Intent it = new Intent(CommentDetailActivity01.this, BindPhoneActivity.class);
...
//                        .setInputText("默认文本")
                                            ...
                                            .configPositive(new ConfigButton() {
                                                ...
                                                public void onConfig(ButtonParams params) {
                                                    //按钮字体颜色
                                                    params.textColor = CommonUtils.getThemeColor(CommentDetailActivity01.this);
                                                }
                                            })

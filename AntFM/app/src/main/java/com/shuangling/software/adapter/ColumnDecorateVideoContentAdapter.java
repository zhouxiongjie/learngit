...
public class ColumnDecorateVideoContentAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public ColumnDecorateVideoContentAdapter(Context context, RecyclerView recyclerView, List<ColumnContent> columnContent) {
        this.mContext = context;
        mRecyclerView = recyclerView;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD) {
            ...
            return new VideoViewHolder(inflater.inflate(R.layout.content_decorate_video_item, parent, false));

...
public class HistoryAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final History content = mHistorys.get(position);
        if (getItemViewType(position) == TYPE_AUDIO) {
            final AudioViewHolder audioViewHolder = (AudioViewHolder) holder;
            if (!TextUtils.isEmpty(content.getPosts().getCover())) {
                Uri uri = Uri.parse(content.getPosts().getCover());
            ...
            audioViewHolder.title.setText(content.getPosts().getTitle());
            //audioViewHolder.name.setText(content.getPosts().getDes());
            if(!TextUtils.isEmpty(content.getPosts().getAudio().getDuration())){
                audioViewHolder.duration.setText(CommonUtils.getShowTime((long) Float.parseFloat(content.getPosts().getAudio().getDuration()) * 1000));
            }
            //audioViewHolder.duration.setText(CommonUtils.getShowTime((long) Float.parseFloat(content.getPosts().getAudio().getDuration())));
            ...
            articleViewHolder.title.setText(content.getPosts().getTitle());
            ...
            if (!TextUtils.isEmpty(content.getPosts().getCover())) {
                ...
                ImageLoader.showThumb(videoViewHolder.logo, R.drawable.article_placeholder);
            }
            ...
            videoViewHolder.title.setText(content.getPosts().getTitle());
            if(!TextUtils.isEmpty(content.getPosts().getVideo().getDuration())){
                videoViewHolder.duration.setText(CommonUtils.getShowTime((long) Float.parseFloat(content.getPosts().getVideo().getDuration()) * 1000));
            }else{
            ...
            videoViewHolder.root.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(mEditorMode){
                        ...
                        it.putExtra("videoId", content.getPost_id());
                        mContext.startActivity(it);
                    }
            ...
            specialViewHolder.title.setText(content.getPosts().getTitle());
            ...
            specialViewHolder.root.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(mEditorMode){
                        ...
                        it.putExtra("specialId", content.getPost_id());
                        mContext.startActivity(it);
                    }
            ...
            gallerieViewHolder.title.setText(content.getPosts().getTitle());
            gallerieViewHolder.count.setText(content.getPosts().getGallerie().getCount()+"图");
            ...
            gallerieViewHolder.root.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(mEditorMode){
                        ...
                        it.putExtra("galleriaId", content.getPost_id());
                        mContext.startActivity(it);
                    }
...
//        TextView name;
    ...
    public int getItemViewType(int position) {
        ...
        if (mHistorys.get(position).getPosts().getType() == 1) {
            return TYPE_AUDIO;
        } else if (mHistorys.get(position).getPosts().getType() == 3) {
            return TYPE_ARTICLE;
        } else if (mHistorys.get(position).getPosts().getType() == 4) {
            return TYPE_VIDEO;
        } else if (mHistorys.get(position).getPosts().getType() == 5) {
            return TYPE_SPECIAL;
        } else {

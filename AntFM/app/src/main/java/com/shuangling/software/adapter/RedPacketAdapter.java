...
public class RedPacketAdapter extends RecyclerView.Adapter {
    ...
    public RedPacketAdapter(Context context, RedPacketDetailInfo redPacketDetailInfo) {
        this.mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEAD) {
            return new HeadViewHolder(mInflater.inflate(R.layout.red_packet_detail_header, parent, false));
        } else {
            return new UserInfoViewHolder(mInflater.inflate(R.layout.red_packet_item, parent, false));
        }
    }

...
public class ArrowRectangleView extends ViewGroup {
        ...
        for (int i = 0; i < a.getIndexCount(); i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.ArrowRectangleView_arrow_height:
                    ...
                    break;
                case R.styleable.ArrowRectangleView_round_radius:
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(l+getPaddingLeft(), top, r - mRadius/2 - mShadowThickness, bottom);
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(new RectF(0, 0, getMeasuredWidth() - mShadowThickness, getMeasuredHeight() -mArrowHeight- mShadowThickness), mRadius, mRadius, paint);
        // draw arrow
        Path path = new Path();
...
//        path.lineTo(startPoint + mArrowWidth / 2, 0);
        int startPoint = getMeasuredWidth()/2;// - mArrowOffset;
        path.moveTo(startPoint, getMeasuredHeight());
        path.lineTo(startPoint + mArrowWidth/2, getMeasuredHeight()-mArrowHeight);
        path.lineTo(startPoint - mArrowWidth / 2, getMeasuredHeight()-mArrowHeight);
        path.close();
        ...
        if (mShadowThickness > 0) {
            ...
            canvas.drawRoundRect(new RectF(mShadowThickness, mShadowThickness, getMeasuredWidth() - mShadowThickness, getMeasuredHeight() -mShadowThickness- mShadowThickness), mRadius, mRadius, paint);
        }

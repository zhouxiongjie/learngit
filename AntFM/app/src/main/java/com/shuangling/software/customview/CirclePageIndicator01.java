...
public class CirclePageIndicator01 extends View implements PageIndicator {
    ...
    public CirclePageIndicator01(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public CirclePageIndicator01(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDotMargin = a.getDimension(R.styleable.CirclePageIndicator_dotMargin, 0);
...
//        }
        ...
        final float threeRadius = mRadius * 2 + mDotMargin;
        final float shortOffset = shortPaddingBefore + mRadius;
        float longOffset = longPaddingBefore + mRadius;
        if (mCentered) {
            if (count > 1) {
                longOffset += (longSize - longPaddingBefore - longPaddingAfter) / 2.0f - (count * 2 * mRadius + (count - 1) * mDotMargin) / 2.0f;
            } else {

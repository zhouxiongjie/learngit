...
// private static float MARGEN_LINE = RADIU_BIG * 3;
    private static float MARGEN_LINE = CommonUtils.dip2px(40);
    //小圆的数量
    ...
    //利率文字
    private String[] text4Rates=new String[]{"标准","大","特大"};
    //依附效果实现
    ...
    public SlideSelectView(Context context, AttributeSet attrs) {
        ...
        countOfSmallCircle = a.getInt(R.styleable.SlideSelectView_circleCount, 3);
...
//    }
        ...
        //画文字
        for (int i = 0; i < countOfSmallCircle; i++) {
//            canvas.drawText(text4Rates[i], circlesX[i] - textWidth / 2,
//                    (mHeight / 2) - RADIU_BIG -
//                            RADIU_SMALL,
//                    mTextPaint);
            canvas.drawText(text4Rates[i], circlesX[i],
                    (mHeight / 2) - RADIU_BIG -
                            RADIU_SMALL,
                    mTextPaint);
        }

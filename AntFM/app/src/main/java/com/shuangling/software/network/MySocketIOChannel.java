 ...
 */
public class MySocketIOChannel extends AbstractChannel {
     ...
     */
    public MySocketIOChannel(Socket socket, String name, EchoOptions options) {
        this.socket = socket;
        this.name = name;
    ...
    public void unbind() {
        ...
        Iterator<Map.Entry<String, List<EchoCallback>>> it = eventsCallbacks.entrySet().iterator();
        while(it.hasNext()){
            Map.Entry<String, List<EchoCallback>> entry = it.next();

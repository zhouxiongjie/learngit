...
public class Config {
    ...
    public static boolean correctConfig=false;
    ...
    public static String callbackAddress = "http://120.77.70.159:8001/api/upload/callback";
    //http://120.77.70.159:8001/api/upload/callback
    ...
    //public static final String STSSERVER = "http://192.168.30.139:11111/sts.php";//STS 地址
    public static String STSSERVER = "http://120.77.70.159:8001/api/upload/getPolicy";//STS 地址

    public static final String uploadFilePath = ""; //本地文件上传地址
    //public static final String bucket = "zhouxiongjie01";
    public static String bucket = "slltsj";
